//Дана матрица А(5x5). Определить массив Х из 5 элементов,
//каждый из которых равен наибольшему элементу
//соответствующей строки матрицы. Определить величину Y, как
//наименьший из положительных элементов массива X.
